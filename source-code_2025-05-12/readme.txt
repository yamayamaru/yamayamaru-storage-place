...
hat02_ili9486_super_aki80.c                 メインプログラムのソース
...
sdcc -mz80 -c -o hat02_ili9486_super_aki80.rel hat02_ili9486_super_aki80.c
sdasz80 -o mycrt0_2_super_aki80.rel mycrt0_2_super_aki80.asm
sdcc -mz80 --code-loc 0x8000 --data-loc 0 --no-std-crt0 -o hat02_ili9486_super_aki80.ihx mycrt0_2_super_aki80.rel  hat02_ili9486_super_aki80.rel 


簡単にビルドできるようにhat02_ili9486_super_aki80-build.batを用意しました
ファイルの中で環境変数SDCC_HOMEにSDCCをインストールしたフォルダのパスを設定してください
あとはコマンドプロンプトでhat02_ili9486_super_aki80-build.batを実行するだけです
