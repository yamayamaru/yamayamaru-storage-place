...
このプログラムはILI9341の16bitカラーモード(65536色)で描画してます
...
graphicstest_ili9486_super_aki80_16bitcolor.ihx        コンパイル済みのインテルHEXファイル

graphicstest_ili9486_super_aki80_16bitcolor.c          メインプログラムのソース
...
sdcc -mz80 -c -o graphicstest_ili9486_super_aki80_16bitcolor.rel graphicstest_ili9486_super_aki80_16bitcolor.c
sdasz80 -o mycrt0_2_super_aki80.rel mycrt0_2_super_aki80.asm
sdcc -mz80 --code-loc 0x8000 --data-loc 0 --no-std-crt0 -o graphicstest_ili9486_super_aki80_16bitcolor.ihx mycrt0_2_super_aki80.rel  graphicstest_ili9486_super_aki80_16bitcolor.rel 


簡単にビルドできるようにgraphicstest_ili9486_super_aki80_16bitcolor-build.batを用意しました
ファイルの中で環境変数SDCC_HOMEにSDCCをインストールしたフォルダのパスを設定してください
あとはコマンドプロンプトでgraphicstest_ili9486_super_aki80_16bitcolor-build.batを実行するだけです
