/*
  ...
  コンパイル方法
      gcc -O2 -o test_midi_data_serial_to_midi01 test_midi_data_serial_to_midi01.c

  実行方法
      ./test_midi_data_serial_to_midi01  serial_device  midi_device
  実行例
      ./test_midi_data_serial_to_midi01  /dev/ttyS1  /dev/snd/midiC2D0
