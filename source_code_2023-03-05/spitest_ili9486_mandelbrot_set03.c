 ...
 *
 * コンパイル方法
 * $ gcc -O2 -c -o yama_ili9486_library_double_buffer.o yama_ili9486_library_double_buffer.c
 * $ gcc -O2 -o spitest_ili9486_mandelbrot_set03 spitest_ili9486_mandelbrot_set03.c yama_ili9486_library_double_buffer.o -lgpiod
 *
 *
 * 実行方法
 *
 ...
 *
 * ILI9486にRDピンがある場合はVCCに接続してください。
 * 
 */
